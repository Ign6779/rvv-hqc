...
extern void gf32v_rvv_mul_gf16(gf32v_word_t *out, const gf32v_word_t *a, const gf32v_word_t *b, unsigned nwords);
extern void gf32v_rvv_mul_gf256(gf32v_word_t *out, const gf32v_word_t *a, const gf32v_word_t *b, unsigned nwords);
extern void gf32v_rvv_mul_gf216(gf32v_word_t *out, const gf32v_word_t *a, const gf32v_word_t *b, unsigned nwords);

// Made this safe but more costly
...
void gf32v_mul_0x2(gf32v_array *out, const gf32v_array *a) {
    if (out == a) {
        gf32v_array tmp;
        gf32v_rvv_mul_0x2(&tmp.plane[0][0], &a->plane[0][0], GF32V_WORDS);
        *out = tmp;
        return;
    }
...
void gf32v_mul_0x5(gf32v_array *out, const gf32v_array *a) {
    if (out == a) {
        gf32v_array tmp;
        gf32v_rvv_mul_0x5(&tmp.plane[0][0], &a->plane[0][0], GF32V_WORDS);
        *out = tmp;
        return;
    }
...
void gf32v_mul_gf16(gf32v_array *out, const gf32v_array *a, const gf32v_array *b) {
    if (out == a || out == b) {
        gf32v_array tmp;
        gf32v_rvv_mul_gf16(&tmp.plane[0][0], &a->plane[0][0], &b->plane[0][0], GF32V_WORDS);
        *out = tmp;
        return;
    }

    gf32v_rvv_mul_gf16(&out->plane[0][0], &a->plane[0][0], &b->plane[0][0], GF32V_WORDS);
}

void gf32v_mul_gf256(gf32v_array *out, const gf32v_array *a, const gf32v_array *b) {
    if (out == a || out == b) {
        gf32v_array tmp;
        gf32v_rvv_mul_gf256(&tmp.plane[0][0], &a->plane[0][0], &b->plane[0][0], GF32V_WORDS);
        *out = tmp;
        return;
    }

    gf32v_rvv_mul_gf256(&out->plane[0][0], &a->plane[0][0], &b->plane[0][0], GF32V_WORDS);
}

void gf32v_mul_gf216(gf32v_array *out, const gf32v_array *a, const gf32v_array *b) {
    if (out == a || out == b) {
        gf32v_array tmp;
        gf32v_rvv_mul_gf216(&tmp.plane[0][0], &a->plane[0][0], &b->plane[0][0], GF32V_WORDS);
        *out = tmp;
        return;
    }

    gf32v_rvv_mul_gf216(&out->plane[0][0], &a->plane[0][0], &b->plane[0][0], GF32V_WORDS);
}